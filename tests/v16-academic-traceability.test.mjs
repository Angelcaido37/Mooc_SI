...
test('NEXUS 16 academic depth and traceability are wired',()=>{
 ...
 assert.match(st,/Centro de aprendizaje/);assert.match(st,/Constancias académicas/);assert.match(te,/Preparación académica/);assert.match(te,/Trazabilidad docente/);
