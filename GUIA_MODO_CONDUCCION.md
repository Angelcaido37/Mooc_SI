# Guía del Modo Conducción de Clase · NEXUS
...
Use los instrumentos docentes que NEXUS habilita dentro de la plataforma en las fases programadas. Observe seis tareas: preparar materiales, operar el cronómetro, localizar apoyos pedagógicos, ajustar el tiempo, activar el plan B y cerrar la bitácora. El archivo XLSX anterior se conserva sólo como referencia técnica y no aparece como descarga en el portal.
