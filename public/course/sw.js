const CACHE = "nexus-v11-arcade-avatares-tienda";
const FILES = [
  "./", "./index.html", "./estudiante.html", "./docente.html", "./styles.css", "./portal.css", "./login.css", "./v4.css", "./tracking.css", "./visual-lessons.css", "./arcade.css", "./app.js", "./arcade-data.js", "./arcade.js", "./teacher-app.js", "./student-cloud.js", "./course-data.js", "./teaching-data.js", "./teacher-detail-data.js", "./technical-labs-data.js", "./visual-lessons-data.js", "./game-data.js", "./firebase-config.js", "./platform.js", "./classroom-links.js", "./manifest.webmanifest",
