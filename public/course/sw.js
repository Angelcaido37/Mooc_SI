const CACHE = "nexus-v15-medicion-semestral-integrada-15-1-permisos-r1";
const FILES = [
  "./", "./index.html", "./estudiante.html", "./docente.html", "./styles.css", "./portal.css", "./login.css", "./v4.css", "./tracking.css", "./visual-lessons.css", "./arcade.css", "./pilot.css", "./conductor.css", "./measurement.css", "./version.js", "./app.js", "./arcade-data.js", "./pilot-data.js", "./measurement-data.js", "./measurement-scoring.js", "./measurement-student.js", "./measurement-teacher.js", "./arcade.js", "./pilot.js", "./teacher-app.js", "./teacher-conductor.js", "./student-cloud.js", "./course-data.js", "./teaching-data.js", "./teacher-detail-data.js", "./technical-labs-data.js", "./visual-lessons-data.js", "./game-data.js", "./firebase-config.js", "./platform.js", "./classroom-links.js", "./manifest.webmanifest", "./instrumentos/encuesta_experiencia_estudiante_v12.csv", "./instrumentos/evaluacion_portal_docente_v12.csv", "./instrumentos/medicion_pre_post_v12.csv", "./instrumentos/diccionario_analitica_v12.csv", "./instrumentos/evaluacion_modo_conduccion_v13.csv", "./instrumentos/evaluacion_modo_conduccion_v13.xlsx",
